...
urlpatterns = [
    ...
    path('dashboard/branch-detail/', views.dashboard_branch_detail, name='dashboard-branch-detail'),
    path('dashboard/branch-detail/export/', views.dashboard_branch_export, name='dashboard-branch-export'),
